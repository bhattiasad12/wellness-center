                            ...
                            <div class="py-5">
                                <table class="kt_datatable_example_1 table table-row-bordered gy-5">
                                    ...
                                    <tbody class="fw-bold text-gray-600">
                                        @for ($i = 0; $i< count($service); $i++) @php $a=$i; $a++; @endphp <tr>
                                            <td>{{$a}}</td>
                                            ...
                                            <td>{{ucwords($service[$i]->zone)}}</td>
                                            <td>{{$service[$i]->session}}</td>
                                            <td>{{$service[$i]->time_limit}} min</td>
                                            ...
                                            <td>
                                                ...
                                                <form style="display: inline-block" method="POST" action="{{ route('service.destroy',$service[$i]->service_id) }}">
                                                    @method('DELETE')
                                                    @csrf
