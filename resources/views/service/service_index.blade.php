                            ...
                            <div class="py-5">
                                <table class="kt_datatable_example_1 table table-row-bordered gy-5">
                                    ...
                                    <tbody class="fw-bold text-gray-600">
                                        <tr>
                                            <td>1</td>
                                            <td><a href="{{ route('service.show', '1') }}" class="fw-bolder text-gray-800 text-hover-primary mb-1">Service
                                                    3</a></td>
                                            <td>Machine A</td>
                                            <td>Hand 2</td>
                                            <td>Face</td>
                                            ...
                                            <td>$299</td>
                                            <td>
                                                <button type="button" class="btn btn-icon btn-sm btn-color-gray-400 btn-active-icon-primary me-2" onclick="editService(1)">
                                                ...
                                                <button class="btn btn-icon btn-sm btn-color-gray-400 btn-active-icon-danger me-2" data-bs-toggle="tooltip" data-bs-original-title="Delete Service">
