                    ...
                    <div class="card card-docs mb-2">
                        <div class="p-10">
                            ...
                            <div class="d-flex align-items-center rounded py-5 px-4 bg-light-info">
                                ...
                                <!--end::Icon-->
                                <!--begin::Description-->
                                <div class="text-gray-700 fw-bold fs-6 lh-lg">Here we have a list of all of the Services that we have.</div>
                                <!--end::Description-->
                            </div>
                            <!--end::Notice-->
                            <!--end::Heading-->
                            ...
                            <div class="py-5">
                                <table class="kt_datatable_example_1 table table-row-bordered gy-5">
                                    ...
                                    <tbody class="fw-bold text-gray-600">
                                        <tr>
                                            <td>1</td>
                                            <td><a href="{{ route('service.show','1') }}" class="fw-bolder text-gray-800 text-hover-primary mb-1">Service 3</a></td>
                                            <td>Machine A</td>
                                            <td>Hand 2</td>
                                            <td>Face</td>
                                            <td>2</td>
                                            ...
                                            <td>$299</td>
                                            <td>
                                                <a href="#kt_modal_edit_service" class="btn btn-icon btn-sm btn-color-gray-400 btn-active-icon-primary me-2" data-bs-toggle="modal" data-bs-original-title="Edit Service">
                                                ...
                                                <a href="" class="btn btn-icon btn-sm btn-color-gray-400 btn-active-icon-danger me-2" data-bs-toggle="tooltip" data-bs-original-title="Delete Service">
                                        ...
                                        <tr>
                                            <td>2</td>
                                            <td><a href="{{ route('service.show','1') }}" class="fw-bolder text-gray-800 text-hover-primary mb-1">Service 4</a></td>
                                            <td>Machine A</td>
                                            <td>Hand 4</td>
                                            <td>Leg</td>
                                            <td>2</td>
                ...
                <form id="" class="form" action="#">
                    ...
                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <input type="text" min="0" name="service" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Service 2" />
                        </div>
                        <div class="fv-row mb-7">
            ...
            <div class="modal-body scroll-y mx-10 my-7">
                ...
                <form id="" class="form" action="#">
                    ...
                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
                        ...
                        <div class="fv-row mb-7">
                            <label class="required fw-bold fs-6 mb-2">Hand</label>
                            <input type="text" name="hand" class="form-control form-control-solid mb-3 mb-lg-0" value="Hand 2" />
                        </div>
                        <div class="fv-row mb-7">
                            <label class="required fw-bold fs-6 mb-2">Service Name</label>
                            <input type="text" min="0" name="service" class="form-control form-control-solid mb-3 mb-lg-0" value="Service 2" />
                        </div>
                        <div class="fv-row mb-7">
                            <label class="required fw-bold fs-6 mb-2">Zone</label>
                            <select name="zone" class="form-control form-control-solid mb-3 mb-lg-0" id="">
                        ...
                        <div class="fv-row mb-7">
                            <label class="required fw-bold fs-6 mb-2">Time Limit (min)</label>
                            <input type="number" name="time_limit" class="form-control form-control-solid mb-3 mb-lg-0" value="20" />
                        </div>
                        <div class="fv-row mb-7">
                            <label class="required fw-bold fs-6 mb-2">Price ($)</label>
                            <input type="number" name="price" class="form-control form-control-solid mb-3 mb-lg-0" value="299" />
                        </div>
