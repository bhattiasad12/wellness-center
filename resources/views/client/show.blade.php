                                ...
                                <div class="d-flex flex-center flex-column py-5">
                                    ...
                                    <div class="fw-bolder mb-3">Total Count
                                        <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="popover"
                                            ...
                                            data-bs-content="Total count of Notes made and the Attachments uploaded for this Client."></i>
                                    </div>
                                    <!--end::Info heading-->
                                    <div class="d-flex flex-wrap flex-center fs-8">
                                        <!--begin::Stats-->
                                        <div
                                            class="border border-gray-300 border-dashed rounded py-3 px-3 mb-3 text-center">
                                        ...
                                        <!--begin::Stats-->
                                        <div
                                            class="border border-gray-300 border-dashed rounded py-3 px-3 mx-4 mb-3 text-center">
                                            <div class="fs-5 fw-bolder text-gray-700">
                                ...
                                <div class="d-flex flex-stack fs-4 py-3">
                                    ...
                                    <span data-bs-toggle="tooltip" data-bs-trigger="hover" title="Edit customer details">
                                        <a href="#" class="btn btn-sm btn-light-primary" data-bs-toggle="modal"
                                            data-bs-target="#kt_modal_edit_client">Edit</a>
                                    </span>
                                </div>
                                <!--end::Details toggle-->
                        ...
                        <ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-bold mb-8">
                            ...
                            <li class="nav-item">
                                <a class="nav-link text-active-primary pb-4" data-bs-toggle="tab"
                                    href="#kt_user_view_cart">Cart</a>
                            </li>
                            <!--end:::Tab item-->
                            <!--begin:::Tab item-->
                            <li class="nav-item">
                                <a class="nav-link text-active-primary pb-4" data-bs-toggle="tab"
                                    href="#kt_user_view_document_attachment">Document Attachments</a>
                            </li>
                            <!--end:::Tab item-->
                        </ul>
                        <!--end:::Tabs-->
                                    ...
                                    <div class="card-header mt-6">
                                        ...
                                        <div class="card-toolbar">
                                            <button type="button" class="btn btn-light-primary btn-sm"
                                                data-bs-toggle="modal" data-bs-target="#kt_modal_add_notes">
                                    ...
                                    <div class="card-body d-flex flex-column">
                                        ...
                                        <div class="d-flex align-items-center position-relative mb-7">
                                            ...
                                            <div class="fw-bold ms-5">
                                                <a href="javascript:;"
                                                    class="fs-5 fw-bolder text-dark text-hover-primary">Create FureStibe
                                                    branding logo</a>
                                ...
                                <div class="card pt-4 mb-6 mb-xl-9">
                                    ...
                                    <div class="card card-flush">
                                        ...
                                        <div class="card-body pt-1">
                                            <!--begin::Table-->
                                            <table data-kt-filemanager-table="files"
                                                class="table align-middle table-row-dashed fs-6 gy-5 kt_datatable_example_1">
                                                <!--begin::Table head-->
                                                <thead>
                                                    <!--begin::Table row-->
                                                    <tr
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-end"
                                                            ...
                                                            <div class="d-flex justify-content-end">
                                                                <!--begin::More-->
                                                                <a href="javascript:;"
                                                                    class="badge badge-lg badge-light-primary p-3 d-inline">Download</a>
                                                                <!--end::More-->
                                                            </div>
                                                        </td>
                                                        <!--end::Actions-->
                                    ...
                                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="" data-kt-scroll="true"
                                        ...
                                        <div class="fv-row mb-7">
                                            ...
                                            <input type="text" name="first_name"
                                                class="form-control form-control-solid mb-3 mb-lg-0" value="Tiger" />
                                        </div>
                                        <div class="fv-row mb-7">
                                            <label class="required fw-bold fs-6 mb-2">Last Name</label>
                                            <input type="text" name="last_name"
                                                class="form-control form-control-solid mb-3 mb-lg-0" value="Nixon" />
                                        </div>
                                        <div class="fv-row mb-7">
                                        ...
                                        <div class="fv-row mb-7">
                                            ...
                                            <input type="number" min="0" name="phone_number"
                                                class="form-control form-control-solid mb-3 mb-lg-0" value="03343394556" />
                                        </div>
                                        <div class="fv-row mb-7">
                                            <label class="required fw-bold fs-6 mb-2">Age</label>
                                            <input type="number" min="0" name="age"
                                                class="form-control form-control-solid mb-3 mb-lg-0" value="45" />
                                        </div>
                                        <div class="fv-row mb-7">
                                            <label class="required fw-bold fs-6 mb-2">Source</label>
                                            <input type="text" name="source"
                                                class="form-control form-control-solid mb-3 mb-lg-0" value="Facebook" />
                                        </div>
                                        <div class="fv-row mb-7">
                                        ...
                                        <div class="fv-row mb-7">
                                            ...
                                            <input type="text" name="city"
                                                class="form-control form-control-solid mb-3 mb-lg-0" value="Karachi" />
                                        </div>
                                        <div class="fv-row mb-7">
                                            <label class="required fw-bold fs-6 mb-2">Zip Code</label>
                                            <input type="text" name="zipcode"
                                                class="form-control form-control-solid mb-3 mb-lg-0" value="74000" />
                                        </div>
