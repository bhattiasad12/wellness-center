                                    ...
                                    <div class="card-body pt-1">
                                        ...
                                        <table data-kt-filemanager-table="files" class="table align-middle table-row-dashed fs-6 gy-5 kt_datatable_example_1">
                                            ...
                                            <tbody class="fw-bold text-gray-600">
                                                @for ($i = 0; $i< count($clientDoc); $i++) <tr>
                                                    <!--begin::Name=-->
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <!--end::Svg Icon-->
                                                            <a href="#" class="text-gray-800 text-hover-primary">{{$clientDoc[$i]->file_name}}</a>
                                                        </div>
                                                    </td>
                                                    <!--end::Name=-->
                                                    <!--begin::Size-->
                                                    <td>{{$clientDoc[$i]->size}} KB</td>
                                                    <!--end::Size-->
                                                    <!--begin::Last modified-->
                                                    <td>{{date("Y-m-d h:i A",strtotime($clientDoc[$i]->created_at))}}</td>
                                                    <!--end::Last modified-->
                                                    <!--begin::Actions-->
                                                    <td class="text-end" data-kt-filemanager-table="action_dropdown">
                                                        <div class="d-flex justify-content-end">
                                                            <!--begin::More-->
                                                            <a href="{{asset($clientDoc[$i]->path)}}" target="_blank" class="badge badge-lg badge-light-primary p-3 d-inline">Download</a>
                                                            <!--end::More-->
                                                        </div>
                                                    </td>
                                                    <!--end::Actions-->
