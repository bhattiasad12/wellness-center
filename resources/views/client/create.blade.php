    ...
    <div class="d-flex flex-column scroll-y me-n7 pe-7">
        <div class="fv-row mb-7">
            ...
            <div class="image-input image-input-outline" data-kt-image-input="true"
                ...
                <label class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow"
                    ...
                    <input onchange="fileValidation(this.id)" type="file" id='avatar' name="avatar"
                        accept=".png, .jpg, .jpeg" />
        ...
        <div class="fv-row mb-7">
            ...
            <input type="text" name="first_name" class="form-control form-control-solid mb-3 mb-lg-0"
                placeholder="Please Enter your First Name here." required />
        </div>
        <div class="fv-row mb-7">
            ...
            <input type="text" name="last_name" class="form-control form-control-solid mb-3 mb-lg-0"
                placeholder="Please Enter your Last Name here." required />
        </div>
        <div class="fv-row mb-7">
            <label class="required fw-bold fs-6 mb-2">Email</label>
            <input id='email' type="email" name="email" onblur="CheckValidEmail(this.id)"
                class="form-control form-control-solid mb-3 mb-lg-0" placeholder="example@domain.com" required />
        </div>
        <div class="fv-row mb-7">
            ...
            <input type="number" min="0" name="phone_number" class="form-control form-control-solid mb-3 mb-lg-0"
                placeholder="Please Enter your Phone Number here." required />
        </div>
        <div class="fv-row mb-7">
            ...
            <input type="number" min="0" name="age" class="form-control form-control-solid mb-3 mb-lg-0"
                placeholder="Please Enter your Age here." required />
        </div>
        <div class="fv-row mb-7">
            <label class="required fw-bold fs-6 mb-2">Source</label>
            <input type="text" name="source" class="form-control form-control-solid mb-3 mb-lg-0"
                placeholder="Please Enter the Source here." required />
        </div>
        <div class="fv-row mb-7">
            ...
            <input type="text" name="neighborhood" class="form-control form-control-solid mb-3 mb-lg-0"
                placeholder="Please Enter your Neighborhood here." required />
        </div>
        <div class="fv-row mb-7">
            ...
            <input type="text" name="city" class="form-control form-control-solid mb-3 mb-lg-0"
                placeholder="Please Enter your City here." required />
        </div>
        <div class="fv-row mb-7">
            <label class="required fw-bold fs-6 mb-2">Zip Code</label>
            <input type="text" name="zipcode" class="form-control form-control-solid mb-3 mb-lg-0"
                placeholder="Please Enter your Zip Code here." required />
        </div>
    </div>
