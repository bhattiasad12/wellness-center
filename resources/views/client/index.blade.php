                                    ...
                                    <table class="kt_datatable_example_1 table table-row-bordered gy-5">
                                        ...
                                        <tbody class="fw-bold text-gray-600">
                                            @for ($i = 0; $i < count($client); $i++)
                                                ...
                                                @endphp <tr>
                                                    <td>{{ $a }}</td>
                                                    <td><a href="{{ route('client.show', $client[$i]->id) }}"
                                                            class="fw-bolder text-gray-800 text-hover-primary mb-1">{{ ucwords($client[$i]->first_name) }}</a>
                                                    </td>
                                                    <td><a href="{{ route('client.show', $client[$i]->id) }}"
                                                            class="fw-bolder text-gray-800 text-hover-primary mb-1">{{ ucwords($client[$i]->last_name) }}</a>
                                                    </td>
                                                    <td>{{ $client[$i]->age }}</td>
                                                    ...
                                                    <td>
                                                        <button
                                                            ...
                                                            onclick="editClient('{{ $client[$i]->id }}')">
                                                            <span class="svg-icon svg-icon-2">
                                                        ...
                                                        <form style="display: inline-block" method="POST"
                                                            action="{{ route('client.destroy', $client[$i]->id) }}">
                                                            @method('DELETE')
                                                            @csrf
                                                            <button
