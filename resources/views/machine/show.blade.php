                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <div class="d-flex flex-wrap fw-bold fs-6 mb-4 pe-2">
                                        <a href="#" class="d-flex align-items-center text-gray-400 text-hover-primary me-5 mb-2">
                                            ...
                                            <!--end::Svg Icon-->Total Hands: <span class="fw-bolder mx-1">2</span>
                                        </a>
                                        <a href="#" class="d-flex align-items-center text-gray-400 text-hover-primary me-5 mb-2">
                                            <!--begin::Svg Icon | path: icons/duotune/communication/com006.svg-->
                                            <span class="svg-icon svg-icon-4 me-1">
                                            ...
                                            <!--end::Svg Icon-->Total Settings: <span class="fw-bolder mx-1">5</span>
                                        </a>
                                    </div>
                                    <!--end::Info-->
                                </div>
                    ...
                    <div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
                        ...
                        <div class="card-header cursor-pointer">
                            ...
                            <div class="card-title m-0">
                                <h3 class="fw-bolder m-0">Hands Listing</h3>
                            </div>
                            <!--end::Card title-->
                        </div>
                        <!--begin::Card header-->
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="#" class="btn btn-icon btn-sm btn-color-gray-400 btn-active-icon-danger" data-bs-toggle="tooltip" data-bs-original-title="Delete Hand">
                ...
                <div class="col-lg-7">
                    <div class="card mb-5 mb-xl-3" id="kt_profile_details_view">
                        ...
                        <div class="card-header cursor-pointer">
                            <!--begin::Card title-->
                            <div class="card-title m-0">
                                <h3 class="fw-bolder m-0">Settings Listing</h3>
                            </div>
                            <!--end::Card title-->
                        </div>
                        <!--begin::Card header-->
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="#" class="btn btn-icon btn-sm btn-color-gray-400 btn-active-icon-danger" data-bs-toggle="tooltip" data-bs-original-title="Delete Setting">
                                                            <!--begin::Svg Icon | path: icons/duotune/general/gen027.svg-->
                                                            <span class="svg-icon svg-icon-2">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                                                    <path d="M5 9C5 8.44772 5.44772 8 6 8H18C18.5523 8 19 8.44772 19 9V18C19 19.6569 17.6569 21 16 21H8C6.34315 21 5 19.6569 5 18V9Z" fill="black"></path>
                    ...
                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
                        <div class="row mb-7">
                            <div class="col-lg-6">
                                ...
                                <select name="hands" class="form-control form-control-solid mb-3 mb-lg-0">
                                    <option>-- Select Hand --</option>
                                    <option value="01 Epilation">01 Epilation</option>
                                    <option value="10 PHOTO">10 PHOTO</option>
                                </select>
                            </div>
                            <div class="col-lg-6">
                                <label class="required fw-bold fs-6 mb-2">Setting Name</label>
                                <input type="text" class="form-control form-control-solid mb-3 mb-lg-0" name="setting_name" placeholder="Please Enter your Setting Name here.">
                            </div>
                        </div>
                        <div class="row mb-7">
                            <div class="col-lg-4">
                                <label class="required fw-bold fs-6 mb-2">Min</label>
                                <input type="text" class="form-control form-control-solid mb-3 mb-lg-0" name="min" placeholder="Please Enter your Min here.">
                            </div>
                            <div class="col-lg-4">
                                <label class="required fw-bold fs-6 mb-2">Max</label>
                                <input type="text" class="form-control form-control-solid mb-3 mb-lg-0" name="max" placeholder="Please Enter your Max here.">
                            </div>
                            <div class="col-lg-4">
                                <label class="required fw-bold fs-6 mb-2">Start</label>
                                <input type="text" class="form-control form-control-solid mb-3 mb-lg-0" name="start" placeholder="Please Enter your Start here.">
                            </div>
                        </div>
                    </div>
                    <!--end::Scroll-->
