                                ...
                                <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                                    <div class="d-flex flex-column">
                                        <div class="d-flex align-items-center mb-2">
                                            <a class="text-gray-900 text-hover-primary fs-2 fw-bolder me-1">Machine: <span
                                                    class="text-primary">IPL</span></a>
                                            <a>
                                        ...
                                        <div class="d-flex flex-wrap fw-bold fs-6 mb-4 pe-2">
                                            <a href="#"
                                                ...
                                                class="fw-bolder mx-1">{{ count($hand) }}</span>
                                            </a>
                                            <a href="#"
                                                class="d-flex align-items-center text-gray-400 text-hover-primary me-5 mb-2">
                                                <span class="svg-icon svg-icon-4 me-1">
                                                ...
                                                class="fw-bolder mx-1">{{ count($handSetting) }}</span>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="d-flex my-4">
                                        <button href="#" class="btn btn-sm btn-circle btn-light-primary me-2"
                                            onclick="addHand()">Add Hands</button>
                                        <button href="#" class="btn btn-sm btn-circle btn-light-warning me-2"
                                            onclick="addSetting()">Add Settings</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                                                        ...
                                                        @endphp <tr>
                                                            ...
                                                            <td>
                                                                <button
                                                                    ...
                                                                    onclick="editHand(`{{ $hand[$i]->hand_id }}`)">
                                                                ...
                                                                <form style="display: inline-block" method="POST"
                                                                    action="{{ route('hand.destroy', $hand[$i]->hand_id) }}">
                                                                    @method('DELETE')
                                                                    @csrf
                                                                    <button href="#"
                                                                        class="btn btn-icon btn-sm btn-color-gray-400 btn-active-icon-danger"
                                                                        data-bs-toggle="tooltip"
                                                                        data-bs-original-title="Delete Hand">
                                                                        <span class="svg-icon svg-icon-2">
                                    ...
                                    <div class="row mb-7">
                                        <div class="col-lg-12">
                                            <table class="kt_datatable_example_1 table table-row-bordered gy-5">
                                                ...
                                                <tbody>
                                                    @for ($i = 0; $i < count($handSetting); $i++)
                                                        @php
                                                            $a = $i;
                                                            $a++;
                                                        @endphp <tr>
                                                            <td>{{ $a }}</td>
                                                            <td>{{ ucwords($handSetting[$i]->hand_name) }}</td>
                                                            <td>{{ ucwords($handSetting[$i]->setting_name) }}</td>
                                                            <td>{{ $handSetting[$i]->min }}</td>
                                                            <td>{{ $handSetting[$i]->max }}</td>
                                                            <td>{{ $handSetting[$i]->start }}</td>
                                                            <td>
                                                                <button
                                                                    class="btn btn-icon btn-sm btn-color-gray-400 btn-active-icon-primary"
                                                                    onclick="editSetting('{{ $handSetting[$i]->id }}')">
                                                                    <span class="svg-icon svg-icon-2">
                                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                                            height="24" viewBox="0 0 24 24" fill="none">
                                                                            <path opacity="0.3"
                                                                ...
                                                                <form style="display: inline-block" method="POST"
                                                                    action="{{ route('hand_setting.destroy', $handSetting[$i]->hand_setting_id) }}">
                                                                    @method('DELETE')
                                                                    @csrf
                                                                    <button href="#"
                                                                        class="btn btn-icon btn-sm btn-color-gray-400 btn-active-icon-danger"
                                                                        data-bs-toggle="tooltip"
                                                                        data-bs-original-title="Delete Setting">
                                                                        <span class="svg-icon svg-icon-2">
                                                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                                                width="24" height="24" viewBox="0 0 24 24"
                                                                                fill="none">
