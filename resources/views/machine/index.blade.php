                                ...
                                <div class="py-5">
                                    <table class="kt_datatable_example_1 table table-row-bordered gy-5">
                                        ...
                                        <tbody class="fw-bold text-gray-600">
                                            <tr>
                                                <td>1</td>
                                                <td><a href="{{ route('machine.show', '1') }}"
                                                        class="fw-bolder text-gray-800 text-hover-primary mb-1">IPL</a></td>
                                                <td>
                                                    <a href="#kt_modal_edit_machine"
                                                    ...
                                                    <a href="{{ route('machine.show', '1') }}"
                                                        class="btn btn-icon btn-sm btn-color-gray-400 btn-active-icon-danger me-2"
                                                        data-bs-toggle="tooltip" data-bs-original-title="Delete Machine">
                                            ...
                                            <tr>
                                                <td>2</td>
                                                <td><a href="{{ route('machine.show', '1') }}"
                                                        class="fw-bolder text-gray-800 text-hover-primary mb-1">ISHAPE</a>
                                                </td>
                                                <td>
                                                    <button
                                                        class="btn btn-icon btn-sm btn-color-gray-400 btn-active-icon-primary me-2"
                                                        data-bs-toggle="modal" data-bs-original-title="Edit Machine">
                                                        <!--begin::Svg Icon | path: icons/duotune/art/art005.svg-->
                                                        <span class="svg-icon svg-icon-2">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                                viewBox="0 0 24 24" fill="none">
