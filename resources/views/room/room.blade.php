                                ...
                                <table class="kt_datatable_example_1 table table-row-bordered gy-5">
                                    ...
                                    <tbody class="fw-bold text-gray-600">
                                        ...
                                        <tr>
                                            ...
                                            <td><input disabled class="color_picker" type="color" value="{{$row->color}}"></td>
                                            <td>
                                                <a href="#kt_modal_edit_room" class="btn btn-icon btn-sm btn-color-gray-400 btn-active-icon-primary me-2" data-bs-toggle="modal" data-bs-original-title="Edit Service">
                                ...
                                <div class="py-5">
                                    <table class="kt_datatable_example_1 table table-row-bordered gy-5">
                                        ...
                                        <tbody class="fw-bold text-gray-600">
                                            <tr>
                                                <td>1</td>
                                                <td><a class="fw-bolder text-gray-800 text-hover-primary mb-1">Room A</a>
                                                </td>
                                                <td><input disabled class="color_picker" type="color" value="#FFB61A">
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>2</td>
                                                <td><a class="fw-bolder text-gray-800 text-hover-primary mb-1">Room B</a>
                                                </td>
                                                <td><input disabled class="color_picker" type="color" value="#8FFFFD">
                                                </td>
                                                <td>
                                                    <a href="#kt_modal_edit_room"
                                                        class="btn btn-icon btn-sm btn-color-gray-400 btn-active-icon-primary me-2"
                ...
                <form id="" class="form" method="POST" action="{{route('room.store')}}">
                    ...
                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
                        <div class="fv-row mb-7">
                            ...
                            <input type="text" name="room" value="{{old('room')}}" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Please Enter the Room Name" />
                        </div>
                        <div class="picker">
                ...
                <div class="modal-body scroll-y mx-10 my-7">
                    ...
                    <form id="" class="form" action="#">
                        ...
                        <div class="d-flex flex-column scroll-y me-n7 pe-7" id="" data-kt-scroll="true"
                            ...
                            <div class="picker">
                                <input class="color_picker color_code" type="color" value="#FFB61A">
                            </div>
                        </div>
                        <!--end::Scroll-->
                        <!--begin::Actions-->
...
>>>>>>> Stashed changes
    ...
    <div class="modal fade" id="kt_modal_edit_room" tabindex="-1" aria-hidden="true">
        <!--begin::Modal dialog-->
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <!--begin::Modal content-->
            <div class="modal-content">
...
<<<<<<< Updated upstream
            ...
            <div class="modal-body scroll-y mx-10 my-7">
                <!--begin::Form-->
                <form id="" class="form" method="POST" action="{{route('room.update','1')}}">
                    @method("PUT");
                    @csrf
                    <!--begin::Scroll-->
                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
                        <div class="fv-row mb-7">
                            <label class="required fw-bold fs-6 mb-2">Room</label>
                            <input type="text" name="room" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Please Enter the Room Name" />
                        </div>
                        <div class="picker">
                            <input name='color' class="color_picker color_code" type="color" value="#FFB61A">
=======
                <!--end::Modal header-->
                <!--begin::Modal body-->
                <div class="modal-body scroll-y mx-10 my-7">
