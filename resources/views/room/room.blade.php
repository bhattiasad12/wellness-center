                    ...
                    <div class="card card-docs mb-2">
                        <div class="p-10">
                            ...
                            <div class="d-flex align-items-center rounded py-5 px-4 bg-light-info">
                                ...
                                <!--end::Icon-->
                                <!--begin::Description-->
                                <div class="text-gray-700 fw-bold fs-6 lh-lg">Here we have a list of all of the Rooms that we have.</div>
                                <!--end::Description-->
                            </div>
                            <!--end::Notice-->
                            <!--end::Heading-->
                        ...
                        <div class="card-header border-0">
                            ...
                            <div class="card-toolbar">
                                ...
                                <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                    <!--begin::Add Room-->
                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_room">
                            ...
                            <div class="py-5">
                                <table class="kt_datatable_example_1 table table-row-bordered gy-5">
                                    ...
                                    <tbody class="fw-bold text-gray-600">
                                        <tr>
                                            <td>1</td>
                                            <td><a class="fw-bolder text-gray-800 text-hover-primary mb-1">Room A</a></td>
                                            <td><input disabled class="color_picker" type="color" value="#FFB61A"></td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>2</td>
                                            <td><a class="fw-bolder text-gray-800 text-hover-primary mb-1">Room B</a></td>
                                            <td><input disabled class="color_picker" type="color" value="#8FFFFD"></td>
                                            <td>
                                                <a href="#kt_modal_edit_room" class="btn btn-icon btn-sm btn-color-gray-400 btn-active-icon-primary me-2" data-bs-toggle="modal" data-bs-original-title="Edit Service">
                                                    <!--begin::Svg Icon | path: icons/duotune/art/art005.svg-->
                                                    <span class="svg-icon svg-icon-2">
