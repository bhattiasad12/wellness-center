                            ...
                            <div class="py-5">
                                <table class="kt_datatable_example_1 table table-row-bordered gy-5">
                                    ...
                                    <tbody class="fw-bold text-gray-600">
                                        @for ($i = 0; $i < count($practitioner); $i++) @php $a=$i; $a++; @endphp <tr>
                                            <td>{{ $a }}</td>
                                            <td><a href="{{ route('practitioner.show', $practitioner[$i]->id) }}" class="fw-bolder text-gray-800 text-hover-primary mb-1">{{ ucwords($practitioner[$i]->first_name) }}</a>
                                            </td>
                                            <td>
                                                ...
                                                <form style="display: inline-block" method="POST" action="{{ route('practitioner.destroy', $practitioner[$i]->id) }}">
                                                    @method('DELETE')
                                                    @csrf
                                                    <button type="submit" class="btn btn-icon btn-sm btn-color-gray-400 btn-active-icon-danger me-2" data-bs-toggle="tooltip" data-bs-original-title="Delete Practitioner">
