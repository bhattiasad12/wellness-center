                    ...
                    <div class="col-xl-4">
                        <div class="card card-xl-stretch mb-5 mb-xl-8">
                            <div class="card-body d-flex align-items-center pt-3 pb-0">
                                ...
                                <img src=" {{ asset('theme/assets/media/svg/avatars/004-boy-1.svg') }}" alt=""
                            ...
                            <div class="card-body d-flex flex-column flex-center">
                                <div class="mb-2">
                                    ...
                                    <div class="flex-grow-1 bgi-no-repeat bgi-size-contain bgi-position-x-center card-rounded-bottom h-200px mh-200px my-5 my-lg-12"
                                        style="background-image:url ({{ asset('theme/assets/media/svg/illustrations/easy/4-dark.svg') }})">
                                    </div>
                                </div>
                                <div class="text-center">
                                    <a href="#" class="btn btn-sm btn-primary me-2" data-bs-toggle="tooltip"
                                        ...
                                        title="Book an Appointment from the Appointments Page">Book Appointment</a>
                                    <a href="#" class="btn btn-sm btn-light" data-bs-toggle="tooltip"
                                        data-bs-dismiss="click" data-bs-custom-class="tooltip-dark"
                                        title="Appointments Listing">View Appointments</a>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="bg-body shadow-sm card-rounded mx-9 mb-9 px-6 py-9 position-relative z-index-1"
                                    ...
                                    <div class="d-flex align-items-center mb-6">
                                        ...
                                        <div class="d-flex align-items-center flex-wrap w-100">
                                            <div class="mb-1 pe-3 flex-grow-1">
                                                <a href="#"
                                                    class="fs-5 text-gray-800 text-hover-primary fw-bolder">Taken</a>
                                            </div>
                                    ...
                                    <div class="d-flex align-items-center mb-6">
                                        ...
                                        <div class="d-flex align-items-center flex-wrap w-100">
                                            <div class="mb-1 pe-3 flex-grow-1">
                                                <a href="#"
                                                    class="fs-5 text-gray-800 text-hover-primary fw-bolder">Confirmed</a>
                                            </div>
                                            <div class="d-flex align-items-center">
                                    ...
                                    <div class="d-flex align-items-center mb-6">
                                        ...
                                        <div class="d-flex align-items-center flex-wrap w-100">
                                            <div class="mb-1 pe-3 flex-grow-1">
                                                <a href="#"
                                                    class="fs-5 text-gray-800 text-hover-primary fw-bolder">Check-In</a>
                                            </div>
                                            <div class="d-flex align-items-center">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="d-flex align-items-center flex-wrap w-100">
                                            <div class="mb-1 pe-3 flex-grow-1">
                                                <a href="#"
                                                    class="fs-5 text-gray-800 text-hover-primary fw-bolder">Cancelled</a>
                                            </div>
                                            <div class="d-flex align-items-center">
