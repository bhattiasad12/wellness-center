                                ...
                                <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                                    <div class="d-flex flex-column">
                                        <div class="d-flex align-items-center mb-2">
                                            <a href="#"
                                                class="text-gray-900 text-hover-primary fs-2 fw-bolder me-1">{{ $data['full_name'] }}</a>
                                            <a href="#">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 fv-row">
                                                <input type="text" name="full_name"
                                                    ...
                                                    placeholder="First name" value="{{ $data['full_name'] }}" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="card-body border-top p-9">
                            <div class="d-flex flex-wrap align-items-center">
                                <div id="" class="flex-row-fluid d-show">
                                    <form id="createPractionerForm" class="form" method="POST"
                                        action="{{ route('center_timimg') }}">
                                        @csrf
                                        <div class="d-flex flex-column scroll-y me-n7 pe-7" id="" data-kt-scroll="true"
                                            data-kt-scroll-activate="{default: false, lg: true}"
                                            data-kt-scroll-max-height=""
                                            data-kt-scroll-dependencies="#kt_modal_add_user_header"
                                            data-kt-scroll-wrappers="#kt_modal_add_user_scroll"
                                            data-kt-scroll-offset="300px">
                                            <table id="daystable" class="table table-row-bordered gy-5">
                                                <thead>
                                                ...
                                                <tbody>
                                                    @for ($i = 0; $i < count($days); $i++)
                                                        <tr>
                                                            <td>
                                                                <input class="form-control form-control-solid" name="days[]"
                                                                    value="{{ ucwords($days[$i]->day) }}" readonly />
                                                            </td>
                                                            <td>
                                                                <input style="text-align:center;"
                                                                    class="form-control form-control-solid kt_datepicker_8"
                                                                    name="check_in[]" value="{{ $days[$i]->start_time }}"
                                                                    {{ $days[$i]->deleted_at == null ? '' : 'readonly' }} />
                                                            </td>
                                                            <td>
                                                                <input style="text-align:center;"
                                                                    class="form-control form-control-solid kt_datepicker_8"
                                                                    name="check_out[]" value="{{ $days[$i]->end_time }}"
                                                                    {{ $days[$i]->deleted_at == null ? '' : 'readonly' }} />
                                                            </td>
                                                            <td>
                                                                <div
                                                                    class="form-check form-switch form-check-custom form-check-solid">
                                                                    <input type="hidden" name="status[]" value="{{ ($days[$i]->deleted_at == null) ? 'on' : 'off' }}">
                                                                    <input class="form-check-input" name="" type="checkbox"
                                                                        value="" onchange="changeStatus(this)"
                                                                        {{ $days[$i]->deleted_at == null ? 'checked' : '' }} />
                                                                </div>
                                                            </td>
