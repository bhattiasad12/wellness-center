                    ...
                    <div class="card card-docs mb-2">
                        <div class="p-10">
                            ...
                            <div class="d-flex align-items-center rounded py-5 px-4 bg-light-info">
                                ...
                                <!--end::Icon-->
                                <!--begin::Description-->
                                <div class="text-gray-700 fw-bold fs-6 lh-lg">Here we have a list of all of the Appointments that are booked.</div>
                                <!--end::Description-->
                            </div>
                            <!--end::Notice-->
                            <!--end::Heading-->
                            ...
                            <div class="py-5">
                                <table class="kt_datatable_example_1 table table-row-bordered gy-5">
                                    ...
                                    <tbody class="fw-bold text-gray-600">
                                        <tr>
                                            <td><a href="{{ route('appointment.show','1') }}" class="fw-bolder text-gray-800 text-hover-primary mb-1">001</a></td>
                                            <td><a href="{{ route('appointment.show','1') }}" class="fw-bolder text-gray-800 text-hover-primary mb-1">11-04-2022</a></td>
                                            <td><a href="{{ route('appointment.show','1') }}" class="fw-bolder text-gray-800 text-hover-primary mb-1">Tiger</a></td>
                                            <td><a href="{{ route('appointment.show','1') }}" class="fw-bolder text-gray-800 text-hover-primary mb-1">Nixon</a></td>
                                            <td>03343394556</td>
                                            <td>IPL</td>
                                            <td>Laser</td>
                                            <td>01 Epilation</td>
                                            ...
                                            <td>08-04-2022</td>
                                            <td>
                                                <a href="#kt_modal_edit_appointment" class="btn btn-icon btn-sm btn-color-gray-400 btn-active-icon-primary me-2" data-bs-toggle="modal" data-bs-original-title="Edit Client">
                                                    <span class="svg-icon svg-icon-2">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
